 ...
 *
 * TODO: DARKGuy, please comment some of this stuff plox.
 */
class GP2DJoyEvent {
public:
...
private:
    ...
    std::map<gp2dInt32, void(*)(void)> m_mapBasicJoyButtonDown;
    std::map<gp2dInt32, void(*)(void)> m_mapBasicJoyButtonUp;
    std::map<gp2dInt32, void(*)(gp2dInt32)> m_mapBasicJoyAxisChange;
     ...
     */
     gp2dBool m_mouseeventsEnabled;

    /**
     * When this variable is set to true, polling mouse events by the
     * inputhandler will be done. This is to (temporarily) disable mouse inputs.
     */
     gp2dBool m_joystickeventsEnabled;
...
public:
     ...
     *  if otherwise.
     */
    void setGlobalKeysEnabled(gp2dBool a_globalkeysEnabled);
     ...
     *  if otherwise.
     */
    void setKeyMapsEnabled(gp2dBool a_keyMapsEnabled);
     ...
     *  if otherwise.
     */
    void setMouseEnabled(gp2dBool a_mouseeventsEnabled);
     ...
     *  if otherwise.
     */
    void setJoystickEnabled(gp2dBool a_joystickeventsEnabled);
     ...
     */
    void setKeyRepeat(gp2dInt32 initialDelay, gp2dInt32 delay);
    ...
    void registerJoystick(gp2dInt32 device, GP2DJoyAction* event);
    void registerJoyButtonDown(gp2dInt32 button, void (*callbackFunction)(void));
    void registerJoyButtonUp(gp2dInt32 button, void (*callbackFunction)(void));
    void registerAxisChange(gp2dInt32 axis, void (*callbackFunction)(gp2dInt32));
