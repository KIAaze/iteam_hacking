...
namespace gp2d {
	...
	class Texture {
		...
		public:
			...
			GLfloat width, height;// Texture width & height after resizing
			GLfloat OriginalWidth, OriginalHeight;// Texture width & height before resizing
...
//--------------------------
	...
	//blits "bit-by-bit" SDL_Surface from src to dst using size of SDL_Rect sr.
