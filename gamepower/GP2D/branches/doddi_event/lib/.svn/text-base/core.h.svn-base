...
namespace gp2d {
	...
	void DrawLine(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat r, GLfloat g, GLfloat b);			// Draw a line from x1,y1 to x2,y2.
	void DrawRectangle(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat r, GLfloat g, GLfloat b);	// Draw a rectangle from top-left to bottom-right.
