	...
	*/
	...
	bool Music::Load(const char *f)
	{
		...
		switch(Mix_GetMusicType(music)){
			...
			MUS_CMD: format="Command-based"; break;
			MUS_WAV: format="WAVE/RIFF"; break;
			MUS_MOD: format="MOD"; break;
			MUS_MID: format="MIDI"; break;
			MUS_OGG: format="OGG"; break;
			MUS_MP3: format="MP3"; break;
