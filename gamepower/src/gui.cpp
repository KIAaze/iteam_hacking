...
Widget::Widget() {
    inputHandler = new GPInputHandler;
...
void Widget::loadTexture(std::string filePath) {
    texture = new GPTexture(filePath);
    sprite = new GPSprite(texture);
    width = texture->getWidth();
    height = texture->getHeight();
}

void Widget::setTexture(GPTexture* newTexture) {
    texture = newTexture;
}

void Widget::registerMouseDown(GPMouseEvent::GPMouseButton button, void (*callbackFunction)(GPMouseEvent&)) {
        inputHandler->registerMouseDown(GPMouseEvent::GPMouseButton button, void (*callbackFunction)(GPMouseEvent&));
}

void Widget::registerMouseUp(GPMouseEvent::GPMouseButton button, void (*callbackFunction)(GPMouseEvent&)) {
        inputHandler->registerMouseUp(GPMouseEvent::GPMouseButton button, void (*callbackFunction)(GPMouseEvent&));
}
...
void Gui::registerMouseButtonDown(int uid, GPMouseEvent::GPMouseButton button, void (*callbackFunction)(GPMouseEvent&)) {
    currentUID = uid;
    widgets[uid]->registerMouseDown(GPMouseEvent::GPMouseButton button, void (*callbackFunction)(GPMouseEvent&));
}

void Gui::registerMouseButtonUp(int uid, GPMouseEvent::GPMouseButton button, void (*callbackFunction)(GPMouseEvent&)) {
    currentUID = uid;
    widgets[uid]->registerMouseUp(GPMouseEvent::GPMouseButton button, void (*callbackFunction)(GPMouseEvent&));
}
