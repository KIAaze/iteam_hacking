#include "globals.h"
#include "iteamMyWeaponNameGoesHere.h"

namespace iteam {



	iteamMyWeaponNameGoesHere::iteamMyWeaponNameGoesHere() : Weapon() {
		/*
	...
	void iteamMyWeaponNameGoesHere::DoBehaviours (
		...
		*/
		if ( m_Active )  {
			int l_Ticks = GameTimer[0].GetTicks() - l_Component->GetStartTicks();
	...
	//  REMEBER:
	// 		If he above if true delete this AND the declaration from the class iteamMyWeaponNameGoesHere.h

	int iteamMyWeaponNameGoesHere::Fire (
	    PlayerObj *a_Player
	    , GLfloat nx
	    , GLfloat ny
	    , GLfloat new_angle
