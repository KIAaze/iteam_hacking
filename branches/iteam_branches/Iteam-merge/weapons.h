...
//			~weapon();		/**< Deconstructor. */
	...
	void AddComponent ( int WeaponID, int TypeID, Texture *texture, bool IsPhysical=true, bool Bounces=true, GLfloat BlastRadius=0, GLfloat BlastFactor=0, GLfloat BlastDamage=0, GLfloat Elasticity=0, int TriggerTime=0, bool Active=true, GLfloat scale=1 );
