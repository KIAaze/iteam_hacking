...
namespace iteam {
	...
	extern vector <PlayerObj *> Player;	/**< Holds a vector of all the players on the game scene. */
	...
	extern gp2d::Sprite Tank_base;
    extern gp2d::Sprite Tank_canon;
...
// 	extern void UnRegisterIngameKeys();
	...
	enum GAME_STATES {
		...
		ITEAM_COUNTDOWN,
		ITEAM_DOWNPOST,
		ITEAM_SINGLEPLAYER_RUNNINGPRE,
		ITEAM_SINGLEPLAYER_RUNNING,
		ITEAM_SINGLEPLAYER_RUNNINGPOST,
	} ;
