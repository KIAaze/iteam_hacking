...
namespace iteam	{
    ...
    )
    {
        ...
        l_TempComponent = new WeaponComponent(
              "New Component"		/**< Weapon's name. */
			, false			        /**< Is the weapon active? */
			, true                  // is a controling component?
			, TypeID                // WeaponID
            , BlastRadius           /**< how big of a boom does it make? */
			, BlastFactor           /**< how much blast does it apply to objects? */
			, BlastDamage           /**< how much damage does it make? */
            , a_TriggerTime * 1000	/**< how many ticks do we wait to blowup? */
			, 0             		/**< when did we start counting? */
			, true          		/**< can this weapon bounce of things? */
			, TypeID
            , true
        );
    ...
    void Weapon::DoBehaviours(int collision)	{
        ...
        switch(TypeID)	{
            ...
            // ==========================================================================================
            case IT_WT_GRENADE:
                newTicks =  Timer[0].GetTicks() - WeaponsList[TypeID].component[0]->StartTicks;
            ...
            case IT_WT_CLUSTERBOMB:
                ...
                printf("\n");
                newTicks =  Timer[0].GetTicks() - WeaponsList[TypeID].component[CompID].StartTicks;
    ...
    */
    ...
    bool Weapon::ComponentTriggered(WeaponComponent* a_Component)
    {
        ...
        int l_Ticks = Timer[0].GetTicks() - a_Component->GetStartTicks();
