...
void Weapons_Init(void)	{
	...
	AddComponent(0, IT_WT_GRENADE, "data/weapons/grenade.png", true, true, (GLfloat) IT_WT_GRENADE_BLAST_RADIUS,IT_WT_GRENADE_BLAST_FACTOR,IT_WT_GRENADE_BLAST_DAMAGE, (GLfloat) 0.0, grenade_time);
