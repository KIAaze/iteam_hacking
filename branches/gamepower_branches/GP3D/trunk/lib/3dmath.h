...
3D MATH HEADER FILE (version 0.0.3)
BY WYBIRAL

MODIFICATIONS BY:
No one at the moment.
===================================================================================
This is the math functions header file.
===================================================================================
CHANGELOG:

0.0.3:
-> No changes were made, except that it was namespaced.
...
#ifndef _GP3D_3DMATH_H
#define _GP3D_3DMATH_H
