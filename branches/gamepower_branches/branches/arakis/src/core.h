...
public:
    /**
     * Creates the GP2DException provided with a descriptive string. The
     * constructor is declared `explicit' to disable possible erroneous use of
     * type conversion.
     *
     * @param description The string used to describe what the exception
     *   actually is.
     */
    explicit GP2DException(std::string description);
     ...
     */
    GP2DException(std::string description, std::string detail);
