...
public:
    ...
    enum GP2DAudioFormat {
        ...
        GP2D_AUDIO_S16MSB = AUDIO_S16MSB,
        /// Unsigned 16 bit samples, same as GP2D_AUDIO_U16LSB
        GP2D_AUDIO_U16 = AUDIO_U16,
        /// Signed 16 bit samples, same as GP2D_AUDIO_S16LSB
     ...
     */
    void setChannels(gp2dInt32 channels);
     ...
     */
    void setChunkSize(gp2dInt32 chunkSize);
     ...
     */
    void setFrequency(gp2dInt32 frequency);
     ...
     */
    void setMixChannels(gp2dInt32 num);
     ...
     */
    void setMasterVolume(gp2dInt32 volume);
...
public:
    ...
    static const gp2dInt32 GP2D_FOREVER = -1;
     ...
     */
    void setLoops(const gp2dInt32 loops);
};
