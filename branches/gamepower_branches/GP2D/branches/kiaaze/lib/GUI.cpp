...
{
	printf("FUNCTION CALL: GUI:: GUI(SDL_Surface *display)\n");
	FILE *f=fopen("debug.log","a");
	fprintf(f,"FUNCTION CALL: GUI:: GUI(SDL_Surface *display)\n");
	fclose(f);

//	PrintDebug("HELLLOOOOOOOOOOOOOOOOOOOOOOOO\n");
...
GUI:: Display(void)
{
	printf("FUNCTION CALL: GUI:: Display(void)\n");
...
{
	printf("FUNCTION CALL: GUI:: Run(GUI_IdleProc idle, int once, int multitaskfriendly)\n");
